<div class="messages index">
	...
	<tr>
			...
			<th><?php echo $this->Paginator->sort('user_receiver_id'); ?></th>
	...
	<tr>
		...
		<td>
			<?php echo $this->Html->link($message['UserReceiver']['username'], array('controller' => 'users', 'action' => 'view', $message['UserReceiver']['id'])); ?>
		</td>
